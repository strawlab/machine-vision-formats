...
fn test_pixfmt_roundtrip() {
    use PixFmt::*;
    let fmts = [
        Mono8, Mono10, Mono10p, Mono12, Mono12p, Mono16, Mono32f, RGB8, BayerRG8, BayerRG32f,
        BayerBG8, BayerBG32f, BayerGB8, BayerGB32f, BayerGR8, BayerGR32f, YUV444, YUV422, NV12,
    ];
    for fmt in &fmts {
